...
//        }
    ...
    public function createVillaPostType()
    {
        ...
        $labels = array(
            ...
            'singular_name'       => _x( 'Holiday Home', 'Post Type Singular Name', 'exploreo-villa-post' ),
            'menu_name'           => __( 'Holiday Homes', 'exploreo-villa-post' ),
            'parent_item_colon'   => __( 'Parent Holiday Home', 'exploreo-villa-post' ),
            'all_items'           => __( 'All Holiday Homes', 'exploreo-villa-post' ),
            'view_item'           => __( 'View Holiday Homes', 'exploreo-villa-post' ),
            'add_new_item'        => __( 'Add New Holiday Home', 'exploreo-villa-post' ),
            'add_new'             => __( 'Add New', 'exploreo-villa-post' ),
            'edit_item'           => __( 'Edit Holiday Home', 'exploreo-villa-post' ),
            'update_item'         => __( 'Update Holiday Home', 'exploreo-villa-post' ),
            'search_items'        => __( 'Search Holiday Homes', 'exploreo-villa-post' ),
        ...
        $args = array(
            'label'               => __( 'Holiday Homes', 'exploreo-villa-post' ),
            'description'         => __( 'Eco Friendly Holiday Homes', 'exploreo-villa-post' ),
            'labels'              => $labels,
